						...
						if (key == ENTER) {
							...
							if (left != 0) {
								...
								if (canonmove == 0) {
									...
									if (red_x[withcanon[0]] > red_x[withcanon[1]]) {
										smallest = red_x[withcanon[0]];
										secondsmallest = red_x[withcanon[1]];
									}
									else if (red_x[withcanon[1]] > red_x[withcanon[0]]) {
										smallest = red_x[withcanon[1]];
										secondsmallest = red_x[withcanon[0]];
									}
									if (newx < secondsmallest) {
										for (int n = 0; n < 1; n++) {
											cout << "장기말 2개 이상은 건너뛸 수 없습니다. 방향키를 다시 누르세요" << endl;
											r = 0;
											left = 0;
											right = 0;
											up = 0;
									...
									for (int i = 2; i < wc_num + 1; i++) {
										if (red_x[withcanon[i]] > smallest) {
											secondsmallest = smallest;
											smallest = red_x[withcanon[i]];
										}
										else if ((red_x[withcanon[i]] < smallest) && (red_x[withcanon[i]] > secondsmallest)) {
											secondsmallest = red_x[withcanon[i]];
										}
										else if (red_x[withcanon[i]] < secondsmallest) {
										}
									}
									if (newx < secondsmallest) {
										for (int n = 0; n < 1; n++) {
							...
							if (up != 0) {
							    ...
							    if (canonmove == 0) {
									...
									if (red_y[withcanon[0]] > red_y[withcanon[1]]) {
										smallest = red_y[withcanon[0]];
										secondsmallest = red_y[withcanon[1]];
									}
									else if (red_y[withcanon[1]] > red_y[withcanon[0]]) {
										smallest = red_y[withcanon[1]];
										secondsmallest = red_y[withcanon[0]];
									}
									if (newx < secondsmallest) {
										for (int n = 0; n < 1; n++) {
											cout << "장기말 2개 이상은 건너뛸 수 없습니다. 방향키를 다시 누르세요" << endl;
									...
									for (int i = 2; i < wc_num + 1; i++) {
										if (red_y[withcanon[i]] > smallest) {
											secondsmallest = smallest;
											smallest = red_y[withcanon[i]];
										}
										else if ((red_y[withcanon[i]] < smallest) && (red_y[withcanon[i]] > secondsmallest)) {
											secondsmallest = red_y[withcanon[i]];
										}
										else if (red_y[withcanon[i]] < secondsmallest) {
										}
									}
									if (newx < secondsmallest) {
										for (int n = 0; n < 1; n++) {
							...
							if (down != 0) {
								...
								if (canonmove == 0) {
									...
									else if (red_x[withcanon[1]] > red_y[withcanon[0]]) {
										smallest = red_y[withcanon[0]];
										secondsmallest = red_y[withcanon[1]];
									}
									if (newx > secondsmallest) {
						...
						if (key == ENTER) {
							...
							if (left != 0) {
								...
								if (canonmove == 0) {
									...
									if (blue_x[withcanon[0]] > blue_x[withcanon[1]]) {
										smallest = blue_x[withcanon[0]];
										secondsmallest = blue_x[withcanon[1]];
									}
									else if (blue_x[withcanon[1]] > blue_x[withcanon[0]]) {
										smallest = blue_x[withcanon[1]];
										secondsmallest = blue_x[withcanon[0]];
									}
									if (newx < secondsmallest) {
										for (int n = 0; n < 1; n++) {
											cout << "장기말 2개 이상은 건너뛸 수 없습니다. 방향키를 다시 누르세요" << endl;
									...
									for (int i = 2; i < wc_num + 1; i++) {
										if (blue_x[withcanon[i]] > smallest) {
											secondsmallest = smallest;
											smallest = blue_x[withcanon[i]];
										}
										else if ((blue_x[withcanon[i]] < smallest) && (blue_x[withcanon[i]] > secondsmallest)) {
											secondsmallest = blue_x[withcanon[i]];
										}
										else if (blue_x[withcanon[i]] < secondsmallest) {
										}
									}
									if (newx < secondsmallest) {
										for (int n = 0; n < 1; n++) {
							...
							if (up != 0) {
								...
								if (canonmove == 0) {
									...
									if (blue_y[withcanon[0]] > blue_y[withcanon[1]]) {
										smallest = blue_y[withcanon[0]];
										secondsmallest = blue_y[withcanon[1]];
									}
									else if (blue_y[withcanon[1]] > blue_y[withcanon[0]]) {
										smallest = blue_y[withcanon[1]];
										secondsmallest = blue_y[withcanon[0]];
									}
									if (newx < secondsmallest) {
										for (int n = 0; n < 1; n++) {
											cout << "장기말 2개 이상은 건너뛸 수 없습니다. 방향키를 다시 누르세요" << endl;
									...
									for (int i = 2; i < wc_num + 1; i++) {
										if (blue_y[withcanon[i]] > smallest) {
											secondsmallest = smallest;
											smallest = blue_y[withcanon[i]];
										}
										else if ((blue_y[withcanon[i]] < smallest) && (blue_y[withcanon[i]] > secondsmallest)) {
											secondsmallest = blue_y[withcanon[i]];
										}
										else if (blue_y[withcanon[i]] < secondsmallest) {
										}
									}
									if (newx < secondsmallest) {
										for (int n = 0; n < 1; n++) {
